...
import mainAvatar from "./main-avatar.jpg"
...
export const kanbanGrid = [
  { headerText: "Сделать", keyField: "Open", allowToggle: true },

  { headerText: "В процессе", keyField: "InProgress", allowToggle: true },

  {
    headerText: "В тестировке",
    keyField: "Testing",
    allowToggle: true,
    isExpanded: false,
  },

  { headerText: "Сделано", keyField: "Close", allowToggle: true },
];
...
export const EditorData = () => (
  <div>
    <h3>
      I know that it hurts sometimes, but it's beautiful Workin' every day, now
      you bleedin' Through your cuticles Passin' through a portal as you're
      Sittin' in your cubicle Isn't life beautiful? I think that life is
      beautiful Tryna keep it cool at your grandfather's funeral Findin' out
      eventually the feelin' wasn't mutual You were not invited 'Cause you're
      nothin' like the usual Isn't life beautiful? I think that life is
      beautiful You wanna see your friends But you're stuck inside a hospital
      Doctor walks in and he tells you that it's terminal Tumor on your brain
      and they say it's inoperable Isn't life beautiful? I think that life is
      beautiful They'll kill your little brother and They'll tell you he's a
      criminal They'll fuckin' kill you too So you better not get physical
      Welcome to America, that type of shit is typical Isn't life beautiful? I
      think that life is beautiful Wake up in the mornin' Now you doin' the
      impossible Find out what's important Now you feelin' philosophical When I
      die I'll pack my bags Move somewhere more affordable Isn't life horrible?
      I think that life is horrible You think she's adorable She thinks that
      you're intolerable You think you can do it But your chances are improbable
      Once you feel unstoppable, you run into an obstacle Isn't life comical? I
      think that life is comical And if you ever need a friend then you got me
      And in the end, when I die, would you watch me? And if I try suicide,
      would you stop me? Would you help me get a grip or would you drop me?
      Runaway, make friends with the moon Why you trippin'? You'll be with your
      friends soon There comes a time everybody meets the same fate I think I'ma
      die alone inside my room
    </h3>
  </div>
);
...
export const rangeColorMapping = [
  { label: "1°C до 10°C", start: "1", end: "10", colors: colorMappingData[1] },
...
export const employeesGrid = [
  ...
  {
    field: "HireDate",
    headerText: "Дата приема на работу",
    width: "135",
    format: "yMd",
    textAlign: "Center",
  },
...
export const chatData = [
  {
    image: avatar3,
    message: "Роман в нашей команде!",
    desc: "Поздравляем его!",
    time: "9:08",
  },
  {
    image: avatar2,
    message: "Получено новое сообщение",
    desc: "Алина любит вас <3",
    time: "11:56",
  },
  {
    image: avatar4,
    message: "Получен новый платеж",
    desc: "Проверьте свой заработок",
    time: "16:39 ",
  },
  {
    image: avatar,
    message: "Олежа выполнил задания",
    desc: "Назначьте ему новые задачи",
    time: "17:12",
  },
];
...
export const recentTransactions = [
  {
    ...
    amount: "+$350",
    title: "перевод с Paypal",
    desc: "Деньги получены",
    iconColor: "#03C9D7",
    iconBg: "#E5FAFB",
    pcColor: "green-600",
  },
...
export const userProfileData = [
  {
    icon: <BsCurrencyDollar />,
    title: "Мой профиль",
    desc: "Настройки учетной записи",
    iconColor: "#03C9D7",
    iconBg: "#E5FAFB",
  },
  {
    icon: <BsShield />,
    title: "Мой почтовый ящик",
    desc: "Сообщения и электронные письма",
    iconColor: "rgb(0, 194, 146)",
    iconBg: "rgb(235, 250, 242)",
  },
  {
    icon: <FiCreditCard />,
    title: "Мои задачи",
    desc: "Список дел и ежедневные задачи",
    iconColor: "rgb(255, 244, 229)",
    iconBg: "rgb(254, 201, 15)",
  },
];
...
export const ordersData = [
  ...
  },
  {
    ...
    TotalAmount: 95.99,
    OrderItems: "Макияж Lancome Rouge",
    Location: "USA",
    Status: "Отменен",
    StatusBg: "#FF5C8E",
...
export const pieChartData = [
  { x: "Труд", y: 18, text: "18%" },
  { x: "Юридический", y: 8, text: "8%" },
  { x: "Производство", y: 15, text: "15%" },
  { x: "Лицензия", y: 11, text: "11%" },
  { x: "Удобства", y: 18, text: "18%" },
...
export const kanbanData = [
  {
    ...
    Title: "Task - 29001",
    Status: "Open",
    Summary: "Проанализируйте новые требования, полученные от заказчика.",
    Type: "Story",
    Priority: "Low",
  ...
  },
  {
    ...
    Title: "Task - 29002",
    Status: "InProgress",
    Summary: "Улучшить производительность приложений",
    Type: "Improvement",
    Priority: "Normal",
    Tags: "Improvement",
    Estimate: 6,
  ...
  },
  {
    ...
    Status: "Open",
    Summary:
      "Организуйте веб-встречу с заказчиком, чтобы получить новые требования.",
    Type: "Others",
    Priority: "Critical",
    Tags: "Meeting",
    Estimate: 5.5,
  ...
  },
  {
    ...
    Title: "Task - 29004",
    Status: "InProgress",
    Summary: "Исправьте проблемы, о которых сообщалось в браузере IE.",
    Type: "Bug",
    Priority: "Critical",
    Tags: "IE",
    Estimate: 2.5,
  ...
  },
  {
    ...
    Title: "Task - 29005",
    Status: "Review",
    Summary: "Исправьте проблемы, о которых сообщил клиент.",
    Type: "Bug",
    Priority: "Low",
    Tags: "Customer",
    Estimate: "3.5",
  ...
  },
  {
    ...
    Title: "Task - 29007",
    Status: "Validate",
    Summary: "Подтвердить новые требования",
    Type: "Improvement",
    Priority: "Low",
    Tags: "Validation",
    Estimate: 1.5,
  ...
  },
  {
    ...
    Title: "Task - 29009",
    Status: "Review",
    Summary: "Исправьте проблемы, о которых сообщалось в браузере Safari.",
    Type: "Bug",
    Priority: "Critical",
    Tags: "Fix,Safari",
    Estimate: 1.5,
  ...
  },
  {
    ...
    Title: "Task - 29010",
    Status: "Close",
    Summary: "Протестируйте приложение в браузере IE",
    Type: "Story",
    Priority: "Low",
    Tags: "Review,IE",
    Estimate: 5.5,
  ...
  },
  {
    ...
    Title: "Task - 29011",
    Status: "Validate",
    Summary: "Проверка проблем, о которых сообщил клиент.",
    Type: "Story",
    Priority: "High",
    Tags: "Validation,Fix",
    Estimate: 1,
  ...
  },
  {
    ...
    Title: "Task - 29015",
    Status: "Open",
    Summary: "Показать полученные данные с сервера в управлении сеткой",
    Type: "Story",
    Priority: "High",
    Tags: "Database,SQL",
    Estimate: 5.5,
  ...
  },
  {
    ...
    Status: "InProgress",
    Summary:
      "Исправление не может открыть ошибку SQL базы данных пользователя по умолчанию.",
    Priority: "Critical",
    Type: "Bug",
  ...
  },
  {
    ...
    Title: "Task - 29017",
    Status: "Review",
    Summary: "Исправьте проблемы, о которых сообщалось в привязке данных.",
    Type: "Story",
    Priority: "Normal",
    Tags: "Databinding",
    Estimate: "3.5",
  ...
  },
  {
    ...
    Title: "Task - 29018",
    Status: "Close",
    Summary: "Проанализируйте соединение SQL Server 2008.",
    Type: "Story",
    Priority: "Critical",
    Tags: "Grid,Sql",
    Estimate: 2,
  ...
  },
  {
    ...
    Title: "Task - 29019",
    Status: "Validate",
    Summary: "Проверка проблем с привязкой данных.",
    Type: "Story",
    Priority: "Low",
    Tags: "Validation",
    Estimate: 1.5,
  ...
  },
  {
    ...
    Title: "Task - 29020",
    Status: "Close",
    Summary: "Анализ управления сеткой.",
    Type: "Story",
    Priority: "High",
    Tags: "Analyze",
    Estimate: 2.5,
  ...
  },
  {
    ...
    Title: "Task - 29021",
    Status: "Close",
    Summary: "Хранимая процедура привязки исходных данных сетки.",
    Type: "Others",
    Priority: "Critical",
    Tags: "Databinding",
    Estimate: 1.5,
  ...
  },
  {
    ...
    Title: "Task - 29022",
    Status: "Close",
    Summary: "Анализ хранимых процедур.",
    Type: "Story",
    Priority: "Critical",
    Tags: "Procedures",
    Estimate: 5.5,
  ...
  },
  {
    ...
    Title: "Task - 29023",
    Status: "Validate",
    Summary: "Проверка ошибок редактирования.",
    Type: "Story",
    Priority: "Critical",
    Tags: "Editing",
    Estimate: 1,
  ...
  },
  {
    ...
    Title: "Task - 29024",
    Status: "Review",
    Summary: "Протестируйте функциональность редактирования.",
    Type: "Story",
    Priority: "Normal",
    Tags: "Editing,Test",
    Estimate: 0.5,
  ...
  },
  {
    ...
    Title: "Task - 29025",
    Status: "Open",
    Summary: "Расширение возможностей редактирования.",
    Type: "Improvement",
    Priority: "Low",
    Tags: "Editing",
    Estimate: 3.5,
  ...
  },
  {
    ...
    Title: "Task - 29026",
    Status: "InProgress",
    Summary: "Улучшить производительность функций редактирования.",
    Type: "Epic",
    Priority: "High",
    Tags: "Performance",
    Estimate: 6,
  ...
  },
  {
    ...
    Status: "Open",
    Summary:
      "Организуйте веб-встречу с заказчиком, чтобы показать демонстрацию редактирования.",
    Type: "Others",
    Priority: "High",
  ...
  },
  {
    ...
    Title: "Task - 29029",
    Status: "Review",
    Summary: "Устраните проблемы редактирования, о которых сообщил клиент.",
    Type: "Bug",
    Priority: "Low",
    Tags: "Editing,Fix",
    Estimate: "3.5",
...
export const PyramidData = [
  { x: "Сладкие угощения", y: 120, text: "120 кал" },
  { x: "молоко, орехи, сыр", y: 435, text: "435 кал" },
  { x: "Овощи", y: 470, text: "470 кал" },
  { x: "Мясо, птица, рыба", y: 475, text: "475 кал" },
  { x: "Фрукты", y: 520, text: "520 кал" },
  { x: "Хлеб, Рис, Макароны", y: 930, text: "930 кал" },
];
